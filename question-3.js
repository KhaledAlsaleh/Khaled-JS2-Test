...
function calculate(numbers, operator) {
    ...
    switch(operator){
        case 'add':
            ...
            return `The Array Is [${numbers}] And The Operator Is ${operator} And The Result ${sum}`;
            break;
        case 'multiply':
            let mult = numbers[0];
            for(let i = 1 ; i<numbers.length ; i++){
            ...
            return `The Array Is [${numbers}] And The Operator Is ${operator} And The Result ${mult}`;
            break;
        case 'divide':
            let div = numbers[0];
            for(let i = 1 ; i<numbers.length ; i++){
            ...
            return `The Array Is [${numbers}] And The Operator Is ${operator} And The Result ${div}`;
            break;
        case 'subtract':
            let sub = numbers[0];
            for(let i = 1 ; i<numbers.length ; i++){
            ...
            return `The Array Is [${numbers}] And The Operator Is ${operator} And The Result ${sub}`;
            break;
        default:
            break;
    }  
